...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        */
        ...
        $this->call([GlobalMemberSeeder::class, GlobalDocumentTypesTableSeeder::class, GlobalGendersTableSeeder::class, GlobalAreaTableSeeder::class, GlobalUsersTableSeeder::class]);
